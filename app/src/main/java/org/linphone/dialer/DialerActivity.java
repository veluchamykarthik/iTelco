...
public class DialerActivity extends MainActivity implements AddressText.AddressChangedListener {
    ...
    protected void onResume() {
        ...
        mDialerText.setTextColor(getResources().getColor(R.color.primary_color));
        mDialerImageView.setImageDrawable(getResources().getDrawable(R.drawable.footer_dialer));
    ...
    private void updateLayout() {
        ...
        if (!atLeastOneCall) {
            if (core.getVideoActivationPolicy().getAutomaticallyInitiate()) {
                ...
                mStartCall.setImageResource(R.drawable.phone_call);
            }
        }
