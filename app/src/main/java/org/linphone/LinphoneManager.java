...
public class LinphoneManager implements SensorEventListener {
    ...
    public LinphoneManager(Context c) {
        ...
        mCallLogDatabaseFile = mBasePath + "/itelco-log-history.db";
        mFriendsDatabaseFile = mBasePath + "/itelco-friends.db";
        mRingSoundFile = mBasePath + "/share/sounds/itelco/rings/notes_of_the_optimistic.mkv";
