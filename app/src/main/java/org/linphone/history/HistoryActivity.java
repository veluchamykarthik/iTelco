...
public class HistoryActivity extends MainActivity {
    ...
    protected void onResume() {
        ...
        mHistoryText.setTextColor(getResources().getColor(R.color.primary_color));
        mHistoryImageView.setImageDrawable(getResources().getDrawable(R.drawable.footer_history));
