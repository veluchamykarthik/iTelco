...
public abstract class MainActivity extends LinphoneGenericActivity
    ...
    protected TextView mDialerText;
    protected ImageView mDialerImageView;
    protected TextView mHistoryText;
    protected ImageView mHistoryImageView;
    protected TextView mContactsText;
    protected ImageView mContactsImageView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDialerText = findViewById(R.id.dialer_text);
        mDialerImageView = findViewById(R.id.dialer_image);
        mHistoryImageView = findViewById(R.id.history_imageView);
        mHistoryText = findViewById(R.id.history_text);
        mContactsText = findViewById(R.id.contacts_text);
        mContactsImageView = findViewById(R.id.contacts_imageView);
    ...
    protected void onResume() {
        ...
        mDialerText.setTextColor(getResources().getColor(R.color.grey_color));
        mDialerImageView.setImageDrawable(getResources().getDrawable(R.drawable.dialer_grey));
        mHistoryText.setTextColor(getResources().getColor(R.color.grey_color));
        mContactsText.setTextColor(getResources().getColor(R.color.grey_color));
        mContactsImageView.setImageDrawable(getResources().getDrawable(R.drawable.dialer_contacts));

        mHistoryImageView.setImageDrawable(getResources().getDrawable(R.drawable.dialer_history));
    ...
    protected void onDestroy() {
        ...
        mDialerImageView = null;
        mDialerText = null;
        //        mHistoryImageView = null;
        //        mHistoryText = null;
        mChatSelected = null;
        mTopBar = null;
        mTopBarTitle = null;
