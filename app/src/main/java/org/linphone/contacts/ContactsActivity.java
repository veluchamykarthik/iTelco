...
public class ContactsActivity extends MainActivity {
    ...
    protected void onResume() {
        ...
        mContactsText.setTextColor(getResources().getColor(R.color.primary_color));
        mContactsImageView.setImageDrawable(getResources().getDrawable(R.drawable.footer_contacts));
    }
